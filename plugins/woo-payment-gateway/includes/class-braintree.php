...
class WC_Braintree_Manager {
	 ...
	 * @var string
	 */
	public $version = '3.2.29';

	public $js_sdk_version = '3.82.0';
	...
	public function woocommerce_init() {
		...
		if ( $this->is_request( 'frontend' ) ) {
			$this->frontend_scripts = new WC_Braintree_Frontend_Scripts( $this->js_sdk_version );
		}
	...
	private function packages() {
		...
		\PaymentPlugins\WooFunnels\Braintree\Package::init();
	}
