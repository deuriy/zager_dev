	...
	public function process_charge( $order ) {
		...
		try {
			...
			if ( $result->success ) {
				...
				throw new \WFOCU_Payment_Gateway_Exception( wc_braintree_errors_from_object( $result ) );
			}
		} catch ( \Braintree\Exception $e ) {
			throw new \WFOCU_Payment_Gateway_Exception( wc_braintree_errors_from_object( $e ) );
		}
	}
