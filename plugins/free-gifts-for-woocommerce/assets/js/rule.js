	...
	var FGF_Admin = {
		init : function ( ) {
			...
			if ( $( $this ).val() === '1' ) {
				...
				$( '.fgf_rule_type' ).closest( 'tr' ).hide() ;
				$( '.fgf_coupon_gift_products' ).closest( 'tr' ).show() ;
				$( '.fgf_apply_coupon' ).closest( 'tr' ).show() ;
				$( '.fgf_coupon_gift_products_qty' ).closest( 'tr' ).show() ;
			} else {
			...
			if ( $( $this ).val() === '2' ) {
				$( '.fgf_rule_allowed_user_count' ).closest( 'tr' ).show() ;
			} else {
				$( '.fgf_rule_allowed_user_count' ).closest( 'tr' ).hide() ;
			}
