...
if ( ! class_exists( 'FGF_Menu_Management' ) ) {
	...
	class FGF_Menu_Management {
		...
		public static function init() {
			...
			add_filter( 'woocommerce_admin_settings_sanitize_option' , array( __CLASS__ , 'sanitize_custom_fields' ) , 10 , 3 ) ;
		}
		...
		public static function sanitize_custom_fields( $value, $option, $raw_value ) {
			...
			return FGF_Settings::save_fields( $value , $option , $raw_value ) ;
		}
