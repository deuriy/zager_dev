		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php
					$coupon_args       = array(
						'class'       => 'fgf_apply_coupon fgf_rule_type' ,
						'name'        => 'fgf_rule[fgf_apply_coupon]' ,
						'list_type'   => 'coupons' ,
						'action'      => 'fgf_json_search_coupons' ,
						'multiple'    => false ,
						'placeholder' => esc_html__( 'Search a Coupon' , 'free-gifts-for-woocommerce' ) ,
						'options'     => $rule_data[ 'fgf_apply_coupon' ] ,
							) ;
					fgf_select2_html( $coupon_args ) ;
					?>
				</td>
			</tr>
			...
			<tr>
				<th scope='row'>
					<label><?php esc_html_e( 'Select Product(s)' , 'free-gifts-for-woocommerce' ) ; ?><span class="required">*</span>
						<?php fgf_wc_help_tip( esc_html__( "The selected Product(s) will be added to the user's cart once the coupon applied" , 'free-gifts-for-woocommerce' ) ) ; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped. ?>
					</label>
				</th>
				<td>
					<?php
					$gift_product_args = array(
						'class'                   => 'fgf_coupon_gift_products fgf_rule_type' ,
			...
			<tr>
				...
				<td>
					<input type="number" class="fgf_rule_type fgf_coupon_gift_products_qty" name="fgf_rule[fgf_coupon_gift_products_qty]" min="1" value="<?php echo esc_attr( $rule_data[ 'fgf_coupon_gift_products_qty' ] ) ; ?>"/>
				</td>				
			</tr>
