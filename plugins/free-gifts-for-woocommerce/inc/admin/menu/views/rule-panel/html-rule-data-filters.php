...
<div id="fgf_rule_data_filters" class="fgf-rule-options-wrapper">
	<table class="form-table">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<select name="fgf_rule[fgf_applicable_categories_type]" class="fgf_product_filter fgf_applicable_categories_type">
						...
						<option value="4" <?php selected( $rule_data[ 'fgf_applicable_categories_type' ] , '4' ) ; ?>><?php esc_html_e( 'Total Quantity of the Product(s) from the selected categories' , 'free-gifts-for-woocommerce' ) ; ?></option>
					</select>
				</td>
			</tr>
			...
			<tr>
				<th scope='row'>
					<label><?php esc_html_e( 'Minimum Quantity' , 'free-gifts-for-woocommerce' ) ; ?>
						<?php fgf_wc_help_tip( esc_html__( "The user's cart must contain the minimum quantity mentioned in this option which is the sum of the product(s) quantity that belongs to the selected categories." , 'free-gifts-for-woocommerce' ) ) ; // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped. ?>
					</label>
				</th>
				<td>
