			...
			<table class="fgf-shortcode-table">
				...
				<tr>
					...
					<td><?php esc_html_e( 'The minimum cart subtotal required to receive free gift(s)' , 'free-gifts-for-woocommerce' ) ; ?></td>
								...
								<tr>
					<th>[free_gift_min_category_sub_total]</th>
					<td><?php esc_html_e( 'The minimum category subtotal required in the cart to receive free gift(s)' , 'free-gifts-for-woocommerce' ) ; ?></td>
				</tr>
				<tr>
