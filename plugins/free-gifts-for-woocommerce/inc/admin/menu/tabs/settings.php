...
class FGF_Settings_Tab extends FGF_Settings_Page {
	...
	public function general_section_array() {
		...
		$section_fields[] = array(
			'title'    => esc_html__( 'Allow Shipping Cost for Free Gift' , 'free-gifts-for-woocommerce' ) ,
			'type'     => 'checkbox' ,
			'default'  => 'no' ,
			'desc_tip' => true ,
			'desc'     => esc_html__( 'When enabled, the shipping cost will be consider for free gifts in the order.' , 'free-gifts-for-woocommerce' ) ,
		...
		$section_fields[] = array(
			'title'    => esc_html__( 'Ajax Manual Gift Products Add To Cart' , 'free-gifts-for-woocommerce' ) ,
			'type'     => 'checkbox' ,
			'default'  => 'no' ,
			'desc_tip' => true ,
			'desc'     => esc_html__( ' When enabled, the products which are configured to be given as Free Gifts will be hidden in Shop and Category Pages.' , 'free-gifts-for-woocommerce' ) ,
	...
	public function display_section_array() {
		...
		$section_fields[] = array(
			'title'    => esc_html__( 'Free Gifts display position in the Cart Page' , 'free-gifts-for-woocommerce' ) ,
			'id'       => $this->get_option_key( 'gift_cart_page_display_position' ) ,
			'type'     => 'select' ,
			'default'  => '1' ,
			'options'  => array(
				'1' => esc_html__( 'After Cart Table' , 'free-gifts-for-woocommerce' ) ,
				'2' => esc_html__( 'Before Cart Table' , 'free-gifts-for-woocommerce' ) ,
			) ,
			'desc_tip' => true ,
			'desc'     => esc_html__( 'Select Whether the Gift Products should be displayed Inline or Pop-up' , 'free-gifts-for-woocommerce' ) ,
				) ;
		...
		$section_fields[] = array(
			'title'    => esc_html__( 'Gift Product Name Display Method' , 'free-gifts-for-woocommerce' ) ,
			'id'       => $this->get_option_key( 'gift_display_product_linkable' ) ,
			'class'    => 'fgf_gift_table_display_type fgf_gift_carousel_display_type' ,
			'type'     => 'select' ,
			'default'  => '1' ,
			'options'  => array(
				'1' => esc_html__( 'Only Product Name' , 'free-gifts-for-woocommerce' ) ,
				'2' => esc_html__( 'Product Name with Hyperlink to Product Page' , 'free-gifts-for-woocommerce' ) ,
			) ,
			'desc_tip' => true ,
			'desc'     => esc_html__( 'Select whether to Display the Gift Product Name as Name Only/Name with Hyperlink to Product Page' , 'free-gifts-for-woocommerce' ) ,
				) ;
		$section_fields[] = array(
...
{free_gifts}' ,
	...
	public function messages_section_array() {
		...
		$section_fields[] = array(
			'title'   => esc_html__( 'Success Message - Coupon' , 'free-gifts-for-woocommerce' ) ,
			'type'    => 'text' ,
			'default' => 'Gift product(s) has been added to your cart based on your cart contents.' ,
