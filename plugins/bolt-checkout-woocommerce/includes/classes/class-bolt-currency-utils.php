...
class Bolt_Currency_Utils {
	// Values generated using https://gist.github.com/daisy1754/07680be4ec298b1d3f20bd941bcda852
	static $currency_to_precisions = array(
		"AED" => 2,
		"AFN" => 2,
		"ALL" => 2,
		"AMD" => 2,
	 ...
	 */
	public static function get_precision_for_currency_code( $code ) {
		if ( ! array_key_exists( $code, self::$currency_to_precisions ) ) {
			throw new \Exception( 'unknown currency code: ' . $code );
		}

		return self::$currency_to_precisions[ $code ];
	}
}
