...
if ( ! class_exists( 'Understrap_WP_Primary_Navwalker' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Understrap_WP_Primary_Navwalker extends Walker_Nav_Menu {
