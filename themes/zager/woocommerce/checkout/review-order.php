...
<div class="shop_table woocommerce-checkout-review-order-table">
	...
	<div class="woocommerce-checkout-review-order-table__cart-content">
		...
		<div class="cart-subtotal">
			<div class="cart-subtotal__label"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></div>
			<div class="cart-subtotal__price"><?php wc_cart_totals_subtotal_html(); ?></div>
		</div>
	...
	<div class="order-total">
		<div class="order-total__label"><?php esc_html_e( 'Total', 'woocommerce' ); ?></div>
		<div class="order-total__price"><?php wc_cart_totals_order_total_html(); ?></div>
	</div>
