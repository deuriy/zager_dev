...
<div class="woocommerce-form-coupon-toggle">
  ...
  <?php wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message', __( 'Gift Card / Voucher', 'understrap' ) . ' <a href="#" class="showcoupon">' . __( 'Click here', 'understrap' ) . '</a>' ), 'notice' ); ?>
</div>
...
<form class="checkout_coupon woocommerce-form-coupon" method="post" style="display:none">
	...
	<p class="form-row form-row-last">
		<button type="submit" class="btn btn-outline-primary BtnYellow BtnYellow-coupon" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'understrap' ); ?>"><?php esc_html_e( 'Apply coupon', 'understrap' ); ?></button>
	</p>
