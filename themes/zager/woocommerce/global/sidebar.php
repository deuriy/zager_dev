    ...
    <div class="Sidebar_inner">
      <div class="Filter Sidebar_filter Sidebar_filter-extended" id="Filter" data-page-type="<?php echo $page_type ?>">
                        ...
                        <div class="Checkbox CheckboxList_item">
                          ...
                          <div class="Checkbox_number">
                            <?php
                              ...
                              echo get_products_count_by_term($taxonomy_slug, $term->slug, $additional_tax_query);
                            ?>
                          </div>
                        </div>
                      <?php endforeach ?>
        ...
        <div class="Filter_actions hidden-smPlus">
          <button class="BtnYellow Filter_applyBtn" type="button">Apply</button>
          <button class="Filter_resetBtn" type="button">Cancel</button>
        </div>
      </div>
    </div>
  </div>
