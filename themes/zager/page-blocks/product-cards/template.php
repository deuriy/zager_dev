<?php if ($field['title'] || $field['cards']): ?>
  <div class="ProductCards ProductCards-fullWidth">
    <div class="Container">
      <?php if ($field['title']): ?>
        <h2 class="SectionTitle SectionTitle-center SectionTitle-productCards ProductCards_title">
      ...
      <?php if ($field['cards']): ?>
        <div class="ProductCards_wrapper hidden-xs">
          <?php foreach ($field['cards'] as $id): ?>
            <?php
              $product = wc_get_product($id);
              $product_image = $product->get_image('product-card', array('class' => 'ProductCard_img'));
