    ...
    <div class="ProductSection_wrapper">
      <div class="ProductSection_left">
        <div class="ProductSectionImg">
          ...
          <div class="Tag Tag-stars ProductSectionImg_tag">On sale</div><a class="BtnBlack BtnBlack-transparent BtnBlack-fullScreen ProductSectionImg_fullScreenBtn" href="javascript:;" data-fancybox>full screen</a>
        </div>
      </div>
      <div class="ProductSection_right"><a class="ProductSection_recommendation" href="#"><span class="HighlightedText">#1 Recommended</span> Guitar. <span class="UnderlinedText">345 reviews</span></a>
        ...
        <ul class="ProductSection_categoryTags">
          <li class="ProductSection_categoryTag"><a class="CategoryTag" href="#">Accostic Electric</a></li>
          <li class="ProductSection_categoryTag"><a class="CategoryTag" href="#">Full size</a></li>
        </ul>
        ...
        <ul class="ProductSection_buttons">
          <li class="ProductSection_btnItem"><a class="BtnOutline BtnOutline-product ProductSection_btn" href="#">View options and features</a></li>
          <li class="ProductSection_btnItem"><a class="BtnYellow BtnYellow-product ProductSection_btn" href="#">View total with shipping and case</a></li>
        </ul>
      </div>
    </div>
    <?php
